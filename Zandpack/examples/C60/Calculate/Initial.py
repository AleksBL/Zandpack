...
name             = "Y"
eps              = 1e-4         # RK45 error tolerance
t0, t1           = -50.0, 100.0  # Start and End
...
checkpoints      = list(np.linspace(-35, 800,20))       # When to save full system state
