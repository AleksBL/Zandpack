...
tx1     = 10
tx2     = 10
benzene = sisl.Geometry.fromASE(molecule("C6H6")).sub([0,1,2,3,4,5,7,9,10])
NH2     = sisl.Geometry.fromASE(molecule("NH3")).sub([0,1,2]).rotate(60,[0,0,1]).move([0,2.8,0])
mol     = benzene.add(NH2).rotate(-120,[0,0,1])
C       = sisl.Geometry.fromASE(molecule('C'))
...
D = SiP(dev.cell, dev.xyz, dev.toASE().numbers, 
